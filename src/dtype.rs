...
/// Enumeration of the types supported by numpy arrays
pub enum Dtype {
    Bool,
    I8,
    U8,
...
/// Utility trait to implement array manipulations with generics.
/// This associates each primitive types with its [`Dtype`] variant.
